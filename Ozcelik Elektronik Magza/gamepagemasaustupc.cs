...
{
    public partial class gamepagemasaustupc : Form
    {
        MySqlConnection veritabanibaglantisi = new MySqlConnection("server=localhost; uid=root; pwd=; database=elektronik");
        AnaSayfa anaSayfa= new AnaSayfa();
        public gamepagemasaustupc(AnaSayfa anaSayfa)
        {
            InitializeComponent();
            this.anaSayfa = anaSayfa;
        }

        private void gamepagemasaustupc_Load(object sender, EventArgs e)
        {
        ...
        private void gamepagemasaustupc_FormClosed(object sender, FormClosedEventArgs e)
        {
