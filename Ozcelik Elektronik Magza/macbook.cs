...
namespace Ozcelik_Elektronik_Magza
{
    public partial class macbook : Form
    {
        ...
        public macbook(AnaSayfa anaSayfa)
        {
            InitializeComponent();
        ...
        private void macbook_FormClosing(object sender, FormClosingEventArgs e)
        {

        }

        private void macbook_FormClosed(object sender, FormClosedEventArgs e)
        {
